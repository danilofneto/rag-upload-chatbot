...
def main():
    ...
    st.set_page_config(page_title='SeuRAG-GPT', page_icon='favicon.ico')

    st.header('SeuRAG-GPT')
    ...
    with st.sidebar:
        st.image('./testes/duda.png')

        st.subheader('Bem Vindo!')
        pdf_docs = st.file_uploader("Faça Upload dos seus arquivos", accept_multiple_files=True)
